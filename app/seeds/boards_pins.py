...
def seed_boardpins():
    ...
    board14 = Board(title='cocktails', description='', user_id=1)
    ...
    board1.pins.append(pin13)

    board2.pins.append(pin5)
    board2.pins.append(pin19)
    board2.pins.append(pin20)
    board2.pins.append(pin31)
    board2.pins.append(pin34)

    board3.pins.append(pin4)
    board3.pins.append(pin27)
    board3.pins.append(pin29)

    board4.pins.append(pin34)
    board4.pins.append(pin27)
    board4.pins.append(pin31)
    board4.pins.append(pin3)
    board4.pins.append(pin18)
    board4.pins.append(pin19)
    board4.pins.append(pin20)

    board5.pins.append(pin7)
    board5.pins.append(pin23)
    board5.pins.append(pin26)

    board6.pins.append(pin28)
    board6.pins.append(pin6)
    board6.pins.append(pin36)
    board6.pins.append(pin37)
    board6.pins.append(pin38)
    board6.pins.append(pin39)
    board6.pins.append(pin40)

    board7.pins.append(pin17)
    ...
    board9.pins.append(pin24)
    board9.pins.append(pin30)
    board9.pins.append(pin33)
    board9.pins.append(pin35)

    board10.pins.append(pin15)
    board10.pins.append(pin21)
    board10.pins.append(pin23)
    board10.pins.append(pin26)

    board11.pins.append(pin16)
    board11.pins.append(pin25)
    board11.pins.append(pin32)

    board12.pins.append(pin22)
    board12.pins.append(pin30)
    board12.pins.append(pin35)
    board12.pins.append(pin33)
    board12.pins.append(pin24)

    board13.pins.append(pin14)
    board13.pins.append(pin27)
    board13.pins.append(pin29)

    board14.pins.append(pin36)
    board14.pins.append(pin37)
    board14.pins.append(pin38)
    board14.pins.append(pin39)
    board14.pins.append(pin40)
